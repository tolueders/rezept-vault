...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex items-center gap-3 px-(--card-spacing) pb-(--card-spacing) pt-1",
        className
      )}
      {...props}
    />
